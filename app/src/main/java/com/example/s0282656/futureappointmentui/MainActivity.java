...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button v3 = findViewById(R.id.phone_visit_button);
        Button v2 = findViewById(R.id.new_patient_visit_button);
    ...
    public void buttonClicked(View v){
        ...
        Intent intent = new Intent(this, FutureVisitActivity.class);
        switch(tag){
            case 1:
                break;
            case 2:
